...
public class Util {
	...
	public static String process(String message) throws JSONException,
			IOException {
	...
	public static String getBitlyURL(String longurl) throws JSONException,
			IOException {
		String bitlyurl = null;
		String RESTurl=null;
		...
		try {
			...
			while (id < 3) {
				...
				if ("OK".equals(json.getString("statusCode"))) {
					JSONObject output=json.getJSONObject("results").getJSONObject(
							longurl);
